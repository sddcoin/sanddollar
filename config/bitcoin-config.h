...
#define PACKAGE_BUGREPORT "info@sanddollar.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Sanddollar Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Sanddollar Core 1.0.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "sanddollar"
