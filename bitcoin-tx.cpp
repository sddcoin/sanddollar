...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Sanddollar Core sanddollar-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  sanddollar-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sanddollar transaction") + "\n" +
              "  sanddollar-tx [options] -create [commands]   " + _("Create hex-encoded sanddollar transaction") + "\n" +
              "\n";
